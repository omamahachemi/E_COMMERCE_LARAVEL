            ...
            <div class="shopping-cart-content">
                ...
                <div class="mini-cart-item d-flex border-bottom pb-3">
                  <div class="col-lg-2 col-md-3 col-sm-2 me-4">
                    <a href="#" title="product-image">
                      <img src="{{ asset('images/single-product-thumb1.jpg') }}" class="img-fluid" alt="single-product-item">
                    </a>
                  </div>
              ...
              <div class="mini-cart cart-list p-0 mt-3">
                <div class="mini-cart-item d-flex border-bottom pb-3">
                  <div class="col-lg-2 col-md-3 col-sm-2 me-4">
                    <a href="#" title="product-image">
                      <img src="{{ asset('images/single-product-thumb2.jpg') }}" class="img-fluid" alt="single-product-item">
                    </a>
                  </div>
                  <div class="col-lg-9 col-md-8 col-sm-8">
                    <div class="product-header d-flex justify-content-between align-items-center mb-3">
          ...
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade active show" id="nav-sign-in" role="tabpanel"
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group py-3">
                  ...
                  <input type="email" name="email" placeholder="Your Email Address" class="form-control w-100 rounded-3 p-3" required>
                </div>
            ...
            <div class="tab-pane fade" id="nav-register" role="tabpanel"
              ...
              <form method="POST" action="{{ route('register') }}">
                @csrf
                <div class="form-group py-3">
                  <label class="mb-2" for="register">Name *</label>
                  <input type="text" name="name" placeholder="Your Name" class="form-control w-100 rounded-3 p-3" required>
                </div>
                <div class="form-group py-3">
                  <label class="mb-2" for="register">Email address *</label>
                  <input type="email" name="email" placeholder="Your Email Address" class="form-control w-100 rounded-3 p-3" required>
                </div>
                <div class="form-group pb-3">
                  <label class="mb-2" for="sign-in">Password *</label>
  ...
  <header id="header" class="site-header text-black">
    ...
    <nav id="header-nav" class="navbar navbar-expand-lg">
      <div class="container-lg">
        ...
        <button class="navbar-toggler d-flex d-lg-none order-3 border-0 p-1 ms-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#bdNavbar" aria-controls="bdNavbar" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div class="offcanvas-body">
            <ul id="navbar" class="navbar-nav fw-bold justify-content-end align-items-center flex-grow-1">
              <li class="nav-item dropdown">
                <a class="nav-link me-5 active dropdown-toggle border-0" href="#" data-bs-toggle="dropdown" aria-expanded="false">Home</a>
                <ul class="dropdown-menu fw-bold">
                  <li>
                    <a href="{{ url('/') }}" class="dropdown-item">Home V1</a>
                  </li>
                  <li>
                    <a href="{{ url('/') }}" class="dropdown-item">Home V2</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu fw-bold">
                  <li>
                    <a href="{{ url('/') }}" class="dropdown-item">About Us</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="{{ url('/') }}">Shop</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="{{ url('/') }}">Blog</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="{{ url('/') }}">Single Product</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="{{ url('/') }}">Single Post</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="{{ url('/') }}">Styles</a>
                  </li>
                  <li>
              ...
              <li class="nav-item">
                <a class="nav-link me-5" href="{{ url('/') }}">Shop</a>
              </li>
              <li class="nav-item">
...
@else
    <li class="nav-item dropdown pe-3">
        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <svg class="user me-1" width="24" height="24">
                <use xlink:href="#user"></use>
            </svg>
            {{ Auth::user()->name }}
        </a>
          ...
          <div class="swiper-slide">
            <div class="card d-flex flex-row align-items-end border-0 large jarallax-keep-img">
              ...
              <div class="cart-concern p-3 m-3 p-lg-5 m-lg-5">
                ...
                <a href="{{ url('/') }}" class="text-uppercase light mt-3 d-inline-block text-hover fw-bold light-border">Shop Now</a>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
...
<section id="featured-products" class="product-store">
    <div class="container-md">
        <div class="display-header d-flex align-items-center justify-content-between">
            ...
            <div class="btn-right">
                <a href="{{ url('/') }}" class="d-inline-block text-uppercase text-hover fw-bold">View all</a>
            </div>
        </div>
                ...
                <div class="col mb-4">
                    <div class="product-card position-relative">
                        <div class="card-img">
                            ...
                            <img src="{{ asset('images/' . $product->image_url) }}" alt="{{ $product->name }}" class="product-image img-fluid">
        ...
        <div class="col-lg-6 col-md-6 mb-4">
          <div class="collection-card card border-0 d-flex flex-row align-items-end jarallax-keep-img">
            ...
            <div class="card-detail p-3 m-3 p-lg-5 m-lg-5">
              ...
              <a href="{{ url('/') }}" class="text-uppercase mt-3 d-inline-block text-hover fw-bold">Shop Now</a>
            </div>
          </div>
        </div>
